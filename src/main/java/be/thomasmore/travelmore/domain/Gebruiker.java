...
public class Gebruiker extends Persoon {
    ...
    public void stuurBevestigingsMail(){
        ...
        String msg = "Volg volgende <a href='localhost:8081/travelmore/bevestigreg.xhtml?code=" + getConfirmationToken() + "&id=" + this .getId() + "'>link</a> om uw registratie te bevestigen";
        EmailUtil emailUtil = new EmailUtil();
        emailUtil.sendEmail(to, msg, "Bevestig uw registratie");
    }
